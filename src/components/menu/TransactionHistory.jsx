  ...
  return (
    <div className="p-4 py-10 lg:ml-64 flex-1 min-h-screen bg-gray-50">
      <div className="max-w-[1200px] mx-auto">
        ...
        <p className="text-gray-600 mb-6 text-sm text-start">
            ...
            <table className="w-full whitespace-nowrap">
              <thead>
                <tr className="border-y bg-gray-50">
                  <th className="text-center px-4 py-3 text-sm font-medium">TANGGAL</th>
                  <th className="text-center px-4 py-3 text-sm font-medium">NAMA PENGUNJUNG</th>
                  <th className="text-center px-4 py-3 text-sm font-medium">JENIS TIKET</th>
                  <th className="text-center px-4 py-3 text-sm font-medium">NOMINAL</th>
                  <th className="text-center px-4 py-3 text-sm font-medium">STATUS</th>
                  <th className="text-center px-4 py-3 text-sm font-medium">DETAIL</th>
                </tr>
              </thead>
              <tbody>
