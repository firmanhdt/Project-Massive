    ...
    <div className="p-4 py-10 lg:ml-64 flex-1 min-h-screen bg-gray-50">
      ...
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
        ...
        <p className="text-sm md:text-base text-gray-600 mb-6 text-start">
          Jumlah Data Pengunjung Agrowisata Tepas Papandayan
        </p>
      </div>
          ...
          <table className="w-full min-w-[800px]">
            <thead>
              <tr className="border-b bg-gray-50">
                ...
                <th className="px-4 py-3 text-center text-sm font-semibold">TIPE ID</th>
                <th className="px-4 py-3 text-center text-sm font-semibold">NO ID</th>
                <th className="px-4 py-3 text-center text-sm font-semibold">TIPE TIKET</th>
              </tr>
            </thead>
            <tbody>
