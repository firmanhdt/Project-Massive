          ...
          <table className="w-full min-w-[800px]">
            <thead>
              <tr className="border-b bg-gray-50">
                <th className="px-4 py-3 text-center text-sm font-semibold">NIP</th>
                <th className="px-4 py-3 text-center text-sm font-semibold">NAMA</th>
                <th className="px-4 py-3 text-center text-sm font-semibold">POSISI</th>
                <th className="px-4 py-3 text-center text-sm font-semibold">NO HP</th>
